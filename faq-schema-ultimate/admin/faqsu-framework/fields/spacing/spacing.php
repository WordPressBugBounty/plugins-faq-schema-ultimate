 ...
 *
 */
if ( ! class_exists( 'WPFAQSU_Field_spacing' ) ) {
  class WPFAQSU_Field_spacing extends WPFAQSU_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['all'] ) ) {
        ...
        echo '<input type="number" name="'. esc_attr( $this->field_name( '[all]' ) ) .'" value="'. esc_attr( $value['all'] ) .'"'. $placeholder .' class="wpfaqsu-input-number'. esc_attr( $is_unit ) .'" step="any" />';
        echo ( $unit ) ? '<span class="wpfaqsu--label wpfaqsu--unit">'. esc_attr( $args['units'][0] ) .'</span>' : '';
        echo '</div>';
        ...
        foreach ( $properties as $property ) {
          ...
          echo '<input type="number" name="'. esc_attr( $this->field_name( '['. $property .']' ) ) .'" value="'. esc_attr( $value[$property] ) .'"'. $placeholder .' class="wpfaqsu-input-number'. esc_attr( $is_unit ) .'" step="any" />';
          echo ( $unit ) ? '<span class="wpfaqsu--label wpfaqsu--unit">'. esc_attr( $args['units'][0] ) .'</span>' : '';
          echo '</div>';
