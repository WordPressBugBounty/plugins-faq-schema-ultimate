 ...
 *
 */
if ( ! class_exists( 'WPFAQSU_Field_sortable' ) ) {
  class WPFAQSU_Field_sortable extends WPFAQSU_Fields {
    ...
    public function render() {
      ...
      echo '<div class="wpfaqsu-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="wpfaqsu-sortable-item">';

          echo '<div class="wpfaqsu-sortable-content">';
          ...
          WPFAQSU::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="wpfaqsu-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
