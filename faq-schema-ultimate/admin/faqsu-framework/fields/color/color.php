 ...
 *
 */
if ( ! class_exists( 'WPFAQSU_Field_color' ) ) {
  class WPFAQSU_Field_color extends WPFAQSU_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="wpfaqsu-color"'. $default_attr . $this->field_attributes() .'/>';
