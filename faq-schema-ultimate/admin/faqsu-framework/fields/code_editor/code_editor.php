 ...
 *
 */
if ( ! class_exists( 'WPFAQSU_Field_code_editor' ) ) {
  class WPFAQSU_Field_code_editor extends WPFAQSU_Fields {
    ...
    public function enqueue() {
      ...
      if ( ! wp_style_is( 'wpfaqsu-codemirror' ) ) {
        wp_enqueue_style( 'wpfaqsu-codemirror', esc_url( $this->cdn_url . $this->version .'/lib/codemirror.min.css' ), array(), $this->version );
      }
