 ...
 *
 */
if ( ! class_exists( 'WPFAQSU_Abstract' ) ) {
  abstract class WPFAQSU_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        WPFAQSU::$css = apply_filters( "wpfaqsu_{$this->unique}_output_css", WPFAQSU::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'WPFAQSU_Field_' . $field_type;
