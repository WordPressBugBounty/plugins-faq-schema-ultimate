...
(function($) {
  ...
  function WPFAQSUAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  WPFAQSUAjaxChosen.prototype.init = function() {
  ...
  WPFAQSUAjaxChosen.prototype.events = function() {
  ...
  WPFAQSUAjaxChosen.prototype.search_field_focused = function() {
  ...
  WPFAQSUAjaxChosen.prototype.search_welcome_message = function() {
  ...
  WPFAQSUAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('wpfaqsu-chosen', _this.options.data).done( function( response ) {
  ...
  WPFAQSUAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.wpfaqsu-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.WPFAQSUChosenOrder($hidden_value, true);
  ...
  $.fn.WPFAQSUAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new WPFAQSUAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, WPFAQSUAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  WPFAQSUAbstractChosenOrder = (function() {

    function WPFAQSUAbstractChosenOrder() {}

    WPFAQSUAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    WPFAQSUAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    WPFAQSUAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    WPFAQSUAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    WPFAQSUAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    WPFAQSUAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    WPFAQSUAbstractChosenOrder.WPFAQSUChosenOrder = function(select, order, force) {
    ...
    return WPFAQSUAbstractChosenOrder;
  ...
  $.fn.extend({
    WPFAQSUChosenOrder: function(order, force) {
      return _WPFAQSUChosenOrder.WPFAQSUChosenOrder(this, order, force);
    }
  });

  this._WPFAQSUChosenOrder = (function(_super) {
    __extends(_WPFAQSUChosenOrder, _super);

    function _WPFAQSUChosenOrder() {
      _ref = _WPFAQSUChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _WPFAQSUChosenOrder.relAttributeName = 'data-option-array-index';

    _WPFAQSUChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _WPFAQSUChosenOrder.getDOMElement = function(element) {
    ...
    _WPFAQSUChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _WPFAQSUChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _WPFAQSUChosenOrder;

  })(WPFAQSUAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('wpfaqsu-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('wpfaqsu-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectWPFAQSU = FormSerializer.serializeObject;
    $.fn.serializeJSONWPFAQSU   = FormSerializer.serializeJSON;
  }
