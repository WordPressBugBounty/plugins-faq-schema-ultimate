 ...
 * -----------------------------------------------------------
 *
 * FAQSU FRAMEWORK Gutenberg Block
...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.wpfaqsu_gutenberg_blocks ) { return; }

  Object.values(window.wpfaqsu_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType('wpfaqsu-gutenberg-block/block-'+block.hash, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'wpfaqsu-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.hash,
              className: 'is-secondary wpfaqsu-shortcode-button',
              onClick: function () {
                window.wpfaqsu_gutenberg_props = props;
              },
            }, block.button_title ),
