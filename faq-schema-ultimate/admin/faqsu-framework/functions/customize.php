  ...
  class WP_Customize_Control_WPFAQSU extends WP_Customize_Control {
    ...
    public function render() {
      ...
      if ( ! empty( $this->field['dependency'] ) ) {
        ...
        $visible  = ' wpfaqsu-dependency-control';
    ...
    public function render_field_content() {
      ...
      $complex = apply_filters( 'wpfaqsu_customize_complex_fields', array(
        'accordion',
        'background',
        'border',
        'button_set',
      ...
      $class      = ( $is_complex || $custom ) ? ' wpfaqsu-customize-complex' : '';
      ...
      echo '<div class="wpfaqsu-customize-field'. esc_attr( $class ) .'"'. $atts .'>';

      WPFAQSU::field( $this->field, $this->value(), $this->unique, 'customize' );
